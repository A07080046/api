...
##### 25. [货主通过分店发货线上支付(payForOrderWhenSend)](#25-货主通过分店发货线上支付)
##### 26. [货主通过收货点发货线上支付(payAgentForOrder)](#26-货主通过收货点发货线上支付)
...
## 路线api
##### 49. [物流公司发布路线(publishRoadmap)](#49-物流公司发布路线)
##### 50. [物流公司修改路线(modifyRoadmap)](#50-物流公司修改路线)
##### 51. [物流公司删除路线(removeRoadmap)](#51-物流公司删除路线)
##### 52. [物流公司修改路线价格(setRoadmapPrice)](#52-物流公司修改路线价格)
##### 53. [物流公司修改路线对应送货上门路线价格(setRoadmapSendDoorPrice)](#53-物流公司修改路线对应送货上门路线价格)
##### 54. [物流公司修改路线对应送货上门路线底格(setRoadmapSendDoorBasePrice)](#54-物流公司修改路线对应送货上门路线底格)
##### 55. [物流公司修改路线是否上线(setRoadmapEnable)](#55-物流公司修改路线是否上线)
##### 56. [物流公司修改路线对应的送货上门路线是否上线(setRoadmapSendDoorEnable)](#56-物流公司修改路线对应的送货上门路线是否上线)
##### 57. [物流公司获取路线列表(getRoadmapList)](#57-物流公司获取路线列表)
##### 58. [物流公司获取路线详情(getRoadmapDetail)](#58-物流公司获取路线详情)
##### 59. [货主获取分店路线列表(getRoadmapListInShop)](#59-货主获取分店路线列表)
##### 60. [货主获取收货点路线列表(getRoadmapListInAgent)](#60-货主获取收货点路线列表)
##### 61. [通过预下单群组id获取路线行情(getRoadmapListWithPreOrderGroup)](#61-通过预下单群组id获取路线行情)
##### 62. [通过预下单id获取路线行情(getRoadmapListWithPreOrder)](#62-通过预下单id获取路线行情)
##### 63. [通过货单id获取路线行情(getRoadmapListWithOrder)](#63-通过货单id获取路线行情)
##### 64. [通过货车id获取路线行情(getRoadmapListWithTruck)](#64-通过货车id获取路线行情)
...
## 收货点api
##### 68. [收货点通过手机号获取预下单列表(getPreOrderList)](#68-收货点通过手机号获取预下单列表)
##### 69. [收货点下单(placeOrder)](#69-收货点下单)
##### 70. [收货点修改货单(modifyOrder)](#70-收货点修改货单)
##### 71. [收货点打印二维码(printBarCode)](#71-收货点打印二维码)
##### 72. [收货点打印二货单(printOrderListBill)](#72-收货点打印二货单)
##### 73. [收货点代支付货单(confirmCachPayedForOrderList)](#73-收货点代支付货单)
##### 74. [收货点获取未完成货单(getLastestOrder)](#74-收货点获取未完成货单)
##### 75. [收货点获取订单(getOrders)](#75-收货点获取订单)
##### 76. [收货点获取订单详情(getOrderDetail)](#76-收货点获取订单详情)
##### 77. [收货点获取成员列表(getMemberList)](#77-收货点获取成员列表)
##### 78. [收货点修改成员权限(modifyMemberAuthority)](#78-收货点修改成员权限)
##### 79. [收货点通过手机号搜索成员(getMemberByPhone)](#79-收货点通过手机号搜索成员)
##### 80. [收货点获取关联店铺列表(getReferShopList)](#80-收货点获取关联店铺列表)
##### 81. [收货点设置关联店铺(setReferShop)](#81-收货点设置关联店铺)
##### 82. [收货点添加区域的路线提成(addRegionProfit)](#82-收货点添加区域的路线提成)
##### 83. [收货点获取区域的路线提成列表(getRegionProfitList)](#83-收货点获取区域的路线提成列表)
##### 84. [收货点获取区域的路线提成详情(getRegionProfitDetail)](#84-收货点获取区域的路线提成详情)
##### 85. [收货点修改区域的路线提成(modifyRegionProfit)](#85-收货点修改区域的路线提成)
##### 86. [收货点删除区域的路线提成(removeRegionProfit)](#86-收货点删除区域的路线提成)
##### 87. [收货点批量设置区域的路线提成(setRegionProfitWithList)](#87-收货点批量设置区域的路线提成)
## 同城配送api
##### 88. [获取分店设置了上门自提竞价的物流公司列表(getClientPickShipperList)](#88-获取分店设置了上门自提竞价的物流公司列表)
##### 89. [短途物流公司扫描入库(placeStorage)](#89-短途物流公司扫描入库)
##### 90. [短途物流公司设置送货上门(setClientPickOrderTransportFee)](#90-短途物流公司设置送货上门)
##### 91. [短途物流公司设置货车(setCityTruck)](#91-短途物流公司设置货车)
##### 92. [短途物流公司获取货车详情(getCityTruckDetail)](#92-短途物流公司获取货车详情)
##### 93. [短途物流公司扫描装车(scanLoadOrderForCityDistribute)](#93-短途物流公司扫描装车)
##### 94. [短途物流公司获取货车的货单列表(getOrderListInCityTruck)](#94-短途物流公司获取货车的货单列表)
## 业务员api
##### 95. [获取业务员列表(getSalesmanList)](#95-获取业务员列表)
##### 96. [替换我的业务员(replaceSalesman)](#96-替换我的业务员)
##### 97. [主动申请业务员(applySalesman)](#97-主动申请业务员)
##### 98. [获取业务员详情(getSalesmanDetail)](#98-获取业务员详情)
##### 99. [获取会员信息(getMembershipData)](#99-获取会员信息)
##### 100. [客户对业务员评分(appraiseSalesman)](#100-客户对业务员评分)
## 活动api
##### 101. [获取活动列表(getPromotions)](#101-获取活动列表)
##### 102. [获取活动详情(getPromotionDetail)](#102-获取活动详情)
## 协议文档
##### 103. [用户协议(user)](#103-用户协议)
##### 104. [获取软件许可协议(software)](#104-获取软件许可协议)
##### 105. [关于(about)](#105-关于)
##### 106. [星级折扣(rankIncome)](#106-星级折扣)
##### 107. [星级规则(rankRule)](#107-星级规则)
...
---
### 25. [货主通过分店发货线上支付](#25-货主通过分店发货线上支付payfororderwhensend)
- `payForOrderWhenSend`
- 请求方式：`POST`
...
---
### 26. [货主通过收货点发货线上支付](#26-货主通过收货点发货线上支付payagentfororder)
- `payAgentForOrder`
- 请求方式：`POST`
...
---
### 49. [物流公司发布路线](#49-物流公司发布路线publishroadmap)
- `publishRoadmap`
- 请求方式：`POST`
...
```
---
### 50. [物流公司修改路线](#50-物流公司修改路线modifyroadmap)
- `modifyRoadmap`
- 请求方式：`POST`
...
---
### 51. [物流公司删除路线](#51-物流公司删除路线removeroadmap)
- `removeRoadmap`
- 请求方式：`POST`
...
---
### 52. [物流公司修改路线价格](#52-物流公司修改路线价格setroadmapprice)
- `setRoadmapPrice`
- 请求方式：`POST`
...
---
### 53. [物流公司修改路线对应送货上门路线价格](#53-物流公司修改路线对应送货上门路线价格setroadmapsenddoorprice)
...
---
### 54. [物流公司修改路线对应送货上门路线底格](#54-物流公司修改路线对应送货上门路线底格setroadmapsenddoorbaseprice)
...
---
### 55. [物流公司修改路线是否上线](#55-物流公司修改路线是否上线setroadmapenable)
- `setRoadmapEnable`
- 请求方式：`POST`
...
---
### 56. [物流公司修改路线对应的送货上门路线是否上线](#56-物流公司修改路线对应的送货上门路线是否上线setroadmapsenddoorenable)
...
---
### 57. [物流公司获取路线列表](#57-物流公司获取路线列表getroadmaplist)
- `getRoadmapList`
- 请求方式：`POST`
...
---
### 58. [物流公司获取路线详情](#58-物流公司获取路线详情getroadmapdetail)
- `getRoadmapDetail`
- 请求方式：`POST`
...
---
### 59. [货主获取分店路线列表](#59-货主获取分店路线列表getroadmaplistinshop)
...
---
### 60. [货主获取收货点路线列表](#60-货主获取收货点路线列表getroadmaplistinagent)
...
---
### 61. [通过预下单群组id获取路线行情](#61-通过预下单群组id获取路线行情getroadmaplistwithpreordergroup)
...
---
### 62. [通过预下单id获取路线行情](#62-通过预下单id获取路线行情getroadmaplistwithpreorder)
...
---
### 63. [通过货单id获取路线行情](#63-通过货单id获取路线行情getroadmaplistwithorder)
...
---
### 64. [通过货车id获取路线行情](#64-通过货车id获取路线行情getroadmaplistwithtruck)
...
### 68. [收货点通过手机号获取预下单列表](#68-收货点通过手机号获取预下单列表getpreorderlist)
- `getPreOrderList`
- 请求方式：`POST`
...
### 70. [收货点修改货单](#70-收货点修改货单modifyorder)
- `modifyOrder`
- 请求方式：`POST`
...
### 71. [收货点打印二维码](#71-收货点打印二维码printbarcode)
- `printBarCode`
- 请求方式：`POST`
...
### 72. [收货点打印二货单](#72-收货点打印二货单printorderlistbill)
- `printOrderListBill`
- 请求方式：`POST`
...
### 73. [收货点代支付货单](#73-收货点代支付货单confirmcachpayedfororderlist)
...
### 74. [收货点获取未完成货单](#74-收货点获取未完成货单getlastestorder)
- `getLastestOrder`
- 请求方式：`POST`
...
---
### 75. [收货点获取订单](#75-收货点获取订单getorders)
- `getOrders`
- 请求方式：`POST`
...
---
### 76. [收货点获取订单详情](#76-收货点获取订单详情getorderdetail)
- `getOrderDetail`
- 请求方式：`POST`
...
---
### 77. [收货点获取成员列表](#77-收货点获取成员列表getmemberlist)
- `getMemberList`
- 请求方式：`POST`
...
---
### 78. [收货点修改成员权限](#78-收货点修改成员权限modifymemberauthority)
- `modifyMemberAuthority`
- 请求方式：`POST`
...
---
### 79. [收货点通过手机号搜索成员](#79-收货点通过手机号搜索成员getmemberbyphone)
- `getMemberByPhone`
- 请求方式：`POST`
...
---
### 80. [收货点获取关联店铺列表](#80-收货点获取关联店铺列表getrefershoplist)
- `getReferShopList`
- 请求方式：`POST`
...
---
### 81. [收货点设置关联店铺](#81-收货点设置关联店铺setrefershop)
- `setReferShop`
- 请求方式：`POST`
...
---
### 82. [收货点添加区域的路线提成](#82-收货点添加区域的路线提成addregionprofit)
- `addRegionProfit`
- 请求方式：`POST`
...
---
### 83. [收货点获取区域的路线提成列表](#83-收货点获取区域的路线提成列表getregionprofitlist)
- `getRegionProfitList`
- 请求方式：`POST`
...
---
### 84. [收货点获取区域的路线提成详情](#84-收货点获取区域的路线提成详情getregionprofitdetail)
...
---
### 85. [收货点修改区域的路线提成](#85-收货点修改区域的路线提成modifyregionprofit)
- `modifyRegionProfit`
- 请求方式：`POST`
...
---
### 86. [收货点删除区域的路线提成](#86-收货点删除区域的路线提成removeregionprofit)
- `removeRegionProfit`
- 请求方式：`POST`
...
---
### 87. [收货点批量设置区域的路线提成](#87-收货点批量设置区域的路线提成setregionprofitwithlist)
...
### 88. [获取分店设置了上门自提竞价的物流公司列表](#88-获取分店设置了上门自提竞价的物流公司列表getclientpickshipperlist)
...
---
### 89. [短途物流公司扫描入库](#89-短途物流公司扫描入库placestorage)
- `placeStorage`
- 请求方式：`POST`
...
---
### 90. [短途物流公司设置送货上门](#90-短途物流公司设置送货上门setclientpickordertransportfee)
...
---
### 91. [短途物流公司设置货车](#91-短途物流公司设置货车setcitytruck)
- `setCityTruck`
- 请求方式：`POST`
...
---
### 92. [短途物流公司获取货车详情](#92-短途物流公司获取货车详情getcitytruckdetail)
- `getCityTruckDetail`
- 请求方式：`POST`
...
---
### 93. [短途物流公司扫描装车](#93-短途物流公司扫描装车scanloadorderforcitydistribute)
...
---
### 94. [短途物流公司获取货车的货单列表](#94-短途物流公司获取货车的货单列表getorderlistincitytruck)
...
---
### 95. [获取业务员列表](#95-获取业务员列表getsalesmanlist)
- `getSalesmanList`
- 请求方式：`POST`
...
---
### 96. [替换我的业务员](#96-替换我的业务员replacesalesman)
- `replaceSalesman`
- 请求方式：`POST`
...
---
### 97. [主动申请业务员](#97-主动申请业务员applysalesman)
- `applySalesman`
- 请求方式：`POST`
...
---
### 98. [获取业务员详情](#98-获取业务员详情getsalesmandetail)
- `getSalesmanDetail`
- 请求方式：`POST`
...
### 99. [获取会员信息](#99-获取会员信息getmembershipdata)
- `getMembershipData`
- 请求方式：`POST`
...
### 100. [客户对业务员评分](#100-客户对业务员评分appraisesalesman)
- `appraiseSalesman`
- 请求方式：`POST`
...
---
### 101. [获取活动列表](#101-获取活动列表getpromotions)
- `getPromotions`
- 请求方式：`POST`
...
| :- |:-:| :-:|
| userId | ID | 用户Id |
| type | String | 类型（nostart, ongoing） |
| pageNo | Number | 页码 |
| pageSize | Number | 页容量 |
| keyword | String | 关键字 |
      ...
      "list": [
        {
          ...
          "price": 100,
          "shipperPrice": 10,
          "startTime": "2018-01-04 14:54:07",
          "endTime": "2018-02-08 14:54:07",
          "modifyTime": "2018-01-02 14:56:12",
          "createTime": "2018-01-02 14:54:55",
          "isHaveSalesmanProfit": true,
          "isStarLevelDiscount": false,
          "descriptList": [
            {
              "text": "desc",
              "img": "http://192.168.1.189:3000/api/image?id=5a4b2cffef4e9418f2ae93f1"
            }
          ],
          "endPointLastCode": 11,
          "startPointLastCode": 520101,
          "id": "5a4b2cbfef4e9418f2ae93ed",
          "shop": {
            "name": "四面通贵阳店",
            "id": "5a331f8259bbe877c873e62c"
          }
        }
      ]
    },
...
---
### 102. [获取活动详情](#102-获取活动详情getpromotiondetail)
- `getPromotionDetail`
- 请求方式：`POST`
...
### 103. [用户协议](#103-用户协议user)
- `user`
- url: `protocals/user.html`

---

### 104. [获取软件许可协议](#104-获取软件许可协议software)
- `software`
...
### 106. [星级折扣](#106-星级折扣rankincome)
- `rankIncome`
- url: `protocals/rankIncome.html`

---

### 107. [星级规则](#107-星级规则rankrule)
- `rankRule`
