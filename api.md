...
##### 14. [获取客户列表(getCustomers)](#14-获取客户列表)
...
---
### 14. [获取客户列表](#14-获取客户列表getcustomers)
- `getCustomers`
- 请求方式：`POST`
...
### 24. [业务员获取下级列表](#24-业务员获取下级列表getsuborlist)
- `getSuborList`
- 请求方式：`POST`
...
| :- |:-:| :-:|
| userId | ID | 用户Id |
| startDate | String | 开始时间 YYYY-MM-DD, 如果不传为今天|
| endDate | String | 结束时间 YYYY-MM-DD, 如果不传为今天|
